...
#___________________-making chnages to data_______________________________-----------------------
...
#print(df.head(5))
#------------------------- change data by filtering-----------------
#df.loc[df["class"] == "Iris-setosa", "class"]="Hedgehog" # changes all elemnts in name from Iris-setosa to Hedgehog
#df.loc[df["class"] == "Iris-setosa", "petal length (cm)"] = 4242 # changes 'petal lenghts' in all elemnts with name 'Iris-setosa' to 4242
#df.loc[df["petal length (cm)"] < 2, "class"] = "tiny petals" # changes name for all elemnts which petal lenght is less than 2

# --------------------group by--------------------------------------------
print(df.groupby(["class"]).mean()) #mean figures by "class"
